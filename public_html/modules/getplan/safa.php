...
<head>
    ...
    <title>Booking Step 1 - Personal Information - Star Travel</title>
  ...
  <![endif]-->
    ...
    <script type="text/javascript" src="http://ff.kis.v2.scr.kaspersky-labs.com/88F1CEC8-62F5-F14C-80F5-2DB5DB331FFC/main.js"
        charset="UTF-8"></script>
    <link rel="stylesheet" crossorigin="anonymous" href="http://ff.kis.v2.scr.kaspersky-labs.com/FED7E7E8-07A3-7041-B677-BB14BE279CAD/abn/main.css"
    />
</head>
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            <li class="dropdown singleDrop ">
                                ...
                                <ul class="dropdown-menu dropdown-menu-left">
                                    ...
                                    <li class="dropdown singleDrop  ">
                                        <a href="index-v2.html">Home City</a>
                                    </li>
                                    <li class="dropdown singleDrop  ">
                                        <a href="index-v3.html">Home Destination</a>
                                    </li>
                                </ul>
                            </li>
                                ...
                                <ul class="row dropdown-menu">
                                    ...
                                    <li class="col-sm-3 col-xs-12">
                                        <ul class="list-unstyled">
                                            ...
                                            <li class="">
                                                <a href="single-package-fullwidth.html">Package Fullwidth</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li class="col-sm-3 col-xs-12">
                                        <ul class="list-unstyled">
                                            <li>Booking Steps</li>
                                            <li class="active">
                                                <a href="booking-1.html">Step 1 - Personal Info</a>
                                            </li>
                                            <li class="">
                                                <a href="booking-2.html">Step 2 - Payment Info</a>
                                            </li>
                                            <li class="">
                                                <a href="booking-3.html">Step 3 - Confirmation</a>
                                            </li>
                                        </ul>
                                    </li>
                                </ul>
                            ...
                            <li class="dropdown singleDrop ">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <li class="dropdown dropdown-submenu ">
                                        <a href="javascript:void(0)" class="dropdown-toggle" data-toggle="dropdown">Destinations
                                            <i class="fa fa-chevron-right" aria-hidden="true"></i>
                                        </a>
                                        <ul class="dropdown-menu dropdown-menu-left">
                                            <li class="">
                            ...
                            <li class="dropdown singleDrop ">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right">
                                    <li class="dropdown dropdown-submenu">
                                        <a href="javascript:void(0)" class="dropdown-toggle" data-toggle="dropdown">Blog Grid View
                                            <i class="fa fa-chevron-right" aria-hidden="true"></i>
                                        </a>
                                        <ul class="dropdown-menu">
                                            <li class="">
                                    ...
                                    <li class="dropdown dropdown-submenu">
                                        <a href="javascript:void(0)" class="dropdown-toggle" data-toggle="dropdown">Blog List View
                                            <i class="fa fa-chevron-right" aria-hidden="true"></i>
                                        </a>
                                        <ul class="dropdown-menu">
                                            <li class="">
                                            ...
                                            <li class="">
                                                <a href="blog-list-left-sidebar.html">blog-list-left-sidebar.html</a>
                                            </li>
                                            <li class="">
                                    ...
                                    <li class="dropdown dropdown-submenu">
                                        <a href="javascript:void(0)" class="dropdown-toggle" data-toggle="dropdown">Single Blog Post
                                            <i class="fa fa-chevron-right" aria-hidden="true"></i>
                                        </a>
                                        <ul class="dropdown-menu">
                                            <li class="">
                            ...
                            <li class="dropdown singleDrop ">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right">
                                    <li class="">
                                        <a href="accordion-and-toggles.html">Accordions &amp; Toggles</a>
                                    </li>
                                    <li class="">
                                        <a href="tabs-and-dropdown.html">Tabs &amp; Dropdowns</a>
                                    </li>
                                    <li class="">
                    ...
                    <div class="col-sm-4 col-sm-push-8 col-xs-12">
                        <aside>
                            ...
                            <div class="bookDetailsInfo">
                                <img src="img/booking/booking.jpg" alt="image">
                                <div class="infoArea">
                                    <h3>Maldives Tour</h3>
                                    <ul class="list-unstyled">
                                        <li>
                                            <i class="fa fa-calendar" aria-hidden="true"></i>From:
                                            <span>25 Mar, 2016</span>
                                        </li>
                                        <li>
                                    ...
                                    <div class="col-xs-12">
                                        <div class="buttonArea galleryBtnArea">
                                            <ul class="list-inline">
                                                <li>
                                                    <a href="#" class="btn buttonTransparent">back</a>
                                                </li>
                                                <li class="pull-right">
                                                    <a href="booking-2.html" class="btn buttonTransparent">next</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3 col-xs-12">
                            <div class="footerContent">
                                ...
                                <ul class="list-unstyled">
                                    <li>
                                        <i class="fa fa-home" aria-hidden="true"></i>61 Park Street, Fifth Avenue, NY</li>
                                    <li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-sm-pull-6 col-xs-12">
                            <div class="copyRightText">
                                <p>Copyright © 2016. All Rights Reserved by
                                    <a target="_blank" href="http://www.iamabdus.com/">Abdus</a>.</p>
                            </div>
                        </div>
                    </div>
                </div>
